...
import com.ads.android.utils.shell.ShellManager;
...
public class PackageUtils {
    ...
    public static CommandResult installApkInShell(Context context, String path) {
        boolean needRoot = !isSystemApp(context);
        return ShellManager.execute("pm install -r " + path, needRoot);
    }
    
    public static void installApkOuter(Context context, File file) {
