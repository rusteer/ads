 ...
 * questions.
 */
package com.ads.android.utils.base64;
...
abstract class CharacterEncoder {
     ...
     */
    protected String encode(byte aBuffer[]) {
     ...
     */
    protected void encode(byte aBuffer[], OutputStream aStream) throws IOException {
        ByteArrayInputStream inStream = new ByteArrayInputStream(aBuffer);
     ...
     */
    protected String encode(ByteBuffer aBuffer) {
     ...
     * The ByteBuffer's position will be advanced to ByteBuffer's limit.
     */
    protected void encode(ByteBuffer aBuffer, OutputStream aStream) throws IOException {
        byte[] buf = getBytes(aBuffer);
        encode(buf, aStream);
    }
    /**
     ...
     * bytes and returns a string containing the encoded buffer.
     */
    protected String encodeBuffer(byte aBuffer[]) {
        ByteArrayOutputStream outStream = new ByteArrayOutputStream();
        ByteArrayInputStream inStream = new ByteArrayInputStream(aBuffer);
        try {
     ...
     * result to the OutputStream <i>aStream</i>.
     */
    protected void encodeBuffer(byte aBuffer[], OutputStream aStream) throws IOException {
        ByteArrayInputStream inStream = new ByteArrayInputStream(aBuffer);
     ...
     * The ByteBuffer's position will be advanced to ByteBuffer's limit.
     */
    protected String encodeBuffer(ByteBuffer aBuffer) {
        byte[] buf = getBytes(aBuffer);
     ...
     * The ByteBuffer's position will be advanced to ByteBuffer's limit.
     */
    protected void encodeBuffer(ByteBuffer aBuffer, OutputStream aStream) throws IOException {
        byte[] buf = getBytes(aBuffer);
     ...
     */
    protected void encodeBuffer(InputStream inStream, OutputStream outStream) throws IOException {
        int j;
        int numBytes;
        byte tmpbuffer[] = new byte[bytesPerLine()];
        encodeBufferPrefix(outStream);
