...
import com.gionee.aora.market.net.SoarNet;
import com.nostra13.universalimageloader.core.ImageLoader;

public class SoarActivity extends MarketBaseActivity {
    public static void startSoarAcivity(Context context, DataCollectInfo datacollectinfo, int i) {
        Intent intent = new Intent(context, SoarActivity.class);
        intent.putExtra("DATACOLLECT_INFO", datacollectinfo);
        intent.putExtra("TYPE", i);
        context.startActivity(intent);
    }
    private static final String TAG = "SoarActivity";
    ...
    protected void initCenterView() {
        ...
        listView.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView adapterview, View view, int i, long l) {
                ...
                IntroductionDetailActivity.startIntroductionActivity(SoarActivity.this, (AppInfo) appInfos.get(i), datacollectinfo);
            }
        });
    ...
    switch (ainteger[0].intValue()) {
        case 0://L2_L2:
            ArrayList arraylist;
            appInfos = SoarNet.getSoarList(ainteger[1].intValue(), 20, type);
            arraylist = appInfos;
            flag = false;
        ...
        case 1://L3_L3:
            ...
            loadMoreInfos = SoarNet.getSoarList(ainteger[1].intValue(), 20, type);
            list = loadMoreInfos;
            flag = false;
