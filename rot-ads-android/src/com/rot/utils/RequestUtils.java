...
import com.rot.callback.MultiDownloadCallback;
...
public class RequestUtils {
    ...
    public static void multiDownload(Context context, final String[] urls, final MultiDownloadCallback callback) {
        ...
        for (int i = 0; i < urls.length; i++) {
            ...
            File file = FileUtils.getUrlFile(context, url);
            download(url, file, new DownloadCallback() {
                @Override
