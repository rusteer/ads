package com.ads.service.framework;
...
public abstract class AbstractCacheService<T extends IdEntity> extends AbstractService<T> {
    ...
    protected abstract List<T> fetchListFromDB(Long key) throws Exception;
