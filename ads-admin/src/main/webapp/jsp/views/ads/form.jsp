...
<form class="form-horizontal" id="bizForm" method="post" action="/${cmpName}/">
		<ul class="nav nav-tabs" id="bizFormTab">
			...
			<li><a href="#tab2" data-toggle="tab">横幅设置</a></li>
			<li><a href="#tab3" data-toggle="tab">弹窗设置</a></li>
			<li><a href="#tab4" data-toggle="tab">推送设置</a></li>
			<li><a href="#tab5" data-toggle="tab">快捷方式设置</a></li>
		</ul>
		<div id="myTabContent" class="tab-content">
			...
			<div class="tab-pane span10" id="tab3">
				 <jsp:include page="modules/pop.jsp" />	
			</div>
			<div class="tab-pane span10" id="tab4">
				 <jsp:include page="modules/push.jsp" />	
			</div>
			<div class="tab-pane span10" id="tab5">
				 <jsp:include page="modules/shortcut.jsp" />	
			</div>
		</div>
