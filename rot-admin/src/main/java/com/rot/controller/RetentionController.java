...
@Controller
@RequestMapping("/" + RetentionController.cmpName)
public class RetentionController extends AbstractController {
    public static final String cmpName = "retention";
    @Autowired
    ...
    public String list(HttpServletRequest request, HttpServletResponse response) {
        ...
        request.setAttribute("list", statService.getRetention(fromDate, toDate, adsId));
