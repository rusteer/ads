...
public class AdsPushService extends AbstractService<AdsPushEntity> {
    ...
    public AdsPushEntity findByAdsId(Long adsId) {
        return dao.findByAdsId(adsId);
    }
    public AdsPushEntity findByAdsIdAndEnabled(Long advtisementId,boolean enabled) {
        return dao.findByAdsIdAndEnabled(advtisementId,enabled);
    }
