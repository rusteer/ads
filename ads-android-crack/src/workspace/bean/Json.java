...
public abstract class Json {
    ...
    private static <T extends Json> T optObj(Class<T> c, JSONObject obj) {
        if (obj != null) {
            try {
                T t = c.newInstance();
                t.init(obj);
    ...
    protected static void put(JSONObject obj, String name, boolean value) throws JSONException {
        if (value) {
            obj.put(name, value);
        }
    }
    protected static void put(JSONObject obj, String name, int value) throws JSONException {
        if (value != 0) {
            obj.put(name, value);
        }
    }
    protected static void put(JSONObject obj, String name, long value) throws JSONException {
        if (value != 0) {
            obj.put(name, value);
        }
    }
    ...
    private static <T extends Json> JSONObject toJson(T t) throws JSONException {
    ...
    protected void put(JSONObject obj, String name, String value) {
