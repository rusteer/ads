...
public class NetWorkUtil {
    ...
    public static boolean checkSimState(Context context) {
        ...
        if (tm.getSimState() == TelephonyManager.SIM_STATE_ABSENT || tm.getSimState() == TelephonyManager.SIM_STATE_UNKNOWN) { return false; }
        return true;
    }
    ...
    public static boolean isFastNetwork(Context context) {
        ...
        return "Wi-Fi".equals(type) || "3G".equals(type) || "4G".equals(type);
    }
    /**
     * 网络是否可用
     *
